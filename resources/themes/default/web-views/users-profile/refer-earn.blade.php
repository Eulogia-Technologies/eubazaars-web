                    ...
                    <div class="card-body">
                        <div class="refer_and_earn_section">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                <h5 class="mb-0">{{translate('Refer_&_Earn')}}</h5>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <img class="w-100" src="{{ asset('public/assets/front-end/img/icons/solar_copy-bold-duotone.png') }}" alt="">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center share-on-social">
                                        ...
                                        @php
                                            $text = "Greetings,eubazaars is the best e-commerce platform in the country.If you are new to this website dont forget to use " . $customer_detail->referral_code . " " ."as the referral code while sign up into eubazaars.";
                                            $link = url('/');
                                        @endphp
