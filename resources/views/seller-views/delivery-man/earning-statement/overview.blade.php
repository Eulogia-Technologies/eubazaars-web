                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card h-100 d-flex justify-content-center align-items-center">
                            <div class="card-body d-flex flex-column gap-10 align-items-center justify-content-center">
                                <img width="48" src="http://localhost/eubazaars/public/assets/back-end/img/cc.png" alt="">
                            ...
                            <a href="{{ route('seller.delivery-man.collect-cash', ['id' => $delivery_man->id]) }}" class="btn btn--primary mb-4">{{translate('collect_Cash')}}</a>
                        </div>
                        <!-- End Card -->
                    </div>
                    <div class="col-lg-8">
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center py-5">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <img width="40" src="http://localhost/eubazaars/public/assets/back-end/img/withdraw-icon.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center py-5">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <img width="40" src="http://localhost/eubazaars/public/assets/back-end/img/aw.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="card card-body h-100 justify-content-center py-5">
                                    <div class="d-flex gap-2 justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <img width="40" class="mb-2" src="http://localhost/eubazaars/public/assets/back-end/img/withdraw.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6 mt-3">
                <div class="card">
                    <div class="card-header text-capitalize">
                        <h5 class="mb-0">{{translate('Delivery_Man_Account')}}</h5>
                    </div>
                    <div class="card-body"
                    ...
                    <div class="card-body"
                        ...
                        <div class="mt-2">
                            <div class="flex-start">
                                ...
                                <div class="mx-1">
                                    <h4>{{$delivery_man->bank_name ? $delivery_man->bank_name : translate('no_data_found')}}</h4>
                                </div>
                            </div>
                            <div class="flex-start">
                                <div><h6>{{translate('branch')}} : </h6></div>
                                <div class="mx-1">
                                    <h6>{{$delivery_man->branch ? $delivery_man->branch : translate('no_data_found')}}</h6>
                                </div>
                            </div>
                            <div class="flex-start">
                                <div><h6>{{translate('holder_name')}} : </h6></div>
                                <div class="mx-1">
                                    <h6>{{$delivery_man->holder_name ? $delivery_man->holder_name : translate('no_data_found')}}</h6>
                                </div>
                            </div>
                            <div class="flex-start">
                                <div><h6>{{translate('account_no')}} : </h6></div>
                                <div class="mx-1">
                                    <h6>{{$delivery_man->account_no ? $delivery_man->account_no : translate('no_data_found')}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
