    ...
    <div class="content container-fluid">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex flex-column align-items-center mx-w450 mx-auto">
                                                    <img src="{{asset('public/assets/back-end/img/slider-3.png')}}"
                                                         ...
                                                         alt="" class="dark-support rounded mb-4">
                                                    <p>
                                                        {{ translate('now_you’ll_be_successfully_able_to_use_the_addons_for_your_eubazaars_website') }}
                                                    </p>
                                                    <p>
                                                        {{ translate('N:B you_can_upload_only_eubazaars’s_theme_templates') }}
                                                        .
                                                    </p>
        ...
        <div class="card mb-5">
            <div class="card-body pl-md-10">
                ...
                <form enctype="multipart/form-data" id="addon_upload_form">
                    @csrf
                    <div class="row g-3">
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                            ...
                            <div class="uploadDnD">
                                <div class="form-group inputDnD input_image input_image_edit rounded-lg" data-title="{{translate('drag_&_drop_file_or_browse_file')}}">
                                    <input type="file" name="file_upload" class="form-control-file text--primary font-weight-bold" id="inputFile" onchange="readUrl(this)" accept=".zip">
                                </div>
                            </div>
                    ...
                    <div class="card theme-card {{ theme_root_path() == $key ? 'theme-active':'' }}">
                        ...
                        <div class="p-2 p-sm-3">
                            <div class="aspect-ration-3:2 border border-color-primary-light radius-10">
                                ...
                                onerror="this.src='{{asset('public/assets/back-end/img/placeholder.png')}}'"\
...
@push('script')
    ...
    <script>
        $('#addon_upload_form').on('submit', function(event){
            ...
            if ($('#inputFile').prop('files').length === 0) {
                ...
                var formData = new FormData(document.getElementById('addon_upload_form'));
