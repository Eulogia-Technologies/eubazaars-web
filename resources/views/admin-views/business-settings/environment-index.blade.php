                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ env('APP_NAME') }}"
                                    ...
                                    placeholder="{{ translate('ex') }} : EFood" required disabled>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ env('BUYER_USERNAME') }}" class="form-control" placeholder="eubazaars-admin-demo-jhisdfhisufjifjfijqw5467" disabled>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
