...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>eubazaars Software Installation</h2>
        <h6 class="fw-normal">Please proceed step by step with proper data according to instructions</h6>
    </div>

    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="eubazaars Software Installation"
                        ...
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="text" id="first-name" class="form-control" name="company_name"
                                           required placeholder="Ex: eubazaars">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="from-group">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <div class="number-input-wrap">
                                        <input type="tel" id="admin_phone" class="form-control" name="admin_phone" required
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    ...
                                    <input type="email" id="admin_email" class="form-control" name="admin_email" required
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="password"
                                           class="d-flex align-items-center gap-2 mb-2">Currency Model</label>
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="password"
                                           class="d-flex align-items-center gap-2 mb-2">Admin Password (At least 8 characters)</label>
                                    <div class="input-inner-end-ele position-relative">
